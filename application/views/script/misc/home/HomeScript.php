<script>
    $(document).ready(function() {
        ...
        $('#tbpiutang thead tr').clone(true).appendTo('#tbpiutang thead');
        $('#tbpiutang thead tr:eq(1) th').each(function(i) {
            ...
            if (i > 0) {
                ...
                $('input', this).on('keyup change', function() {
                    if (tbpiutang.column(i).search() !== this.value) {
                        tbpiutang
                            .column(i)
                            .search(this.value)
                            .draw();
        ...
        var tbpiutang = $("#tbpiutang").DataTable({
            dom: "Bfrtip",
            orderCellsTop: true,
            fixedHeader: true,
            buttons: [],
            ...
            "fnDrawCallback": function() {
                ...
                $('#tbpiutang_info').css('padding-left', 10);
            }
        });
        tbpiutang.on('order.dt search.dt', function() {
            tbpiutang.column(0, {
                search: 'applied',
                order: 'applied'
            }).nodes().each(function(cell, i) {
        ...
        $('#tbstocklimit thead tr').clone(true).appendTo('#tbstocklimit thead');
        $('#tbstocklimit thead tr:eq(1) th').each(function(i) {
            ...
            if (i > 0) {
                ...
                $('input', this).on('keyup change', function() {
                    if (tbstocklimit.column(i).search() !== this.value) {
                        tbstocklimit
                            .column(i)
                            .search(this.value)
                            .draw();
        ...
        var tbstocklimit = $("#tbstocklimit").DataTable({
            dom: "Bfrtip",
            orderCellsTop: true,
            fixedHeader: true,
            buttons: [],
            ajax: {
                "url": window.location.href + "/GetListStockLimit",
                "type": "POST",
                "data": function(d) {
            ...
            "fnDrawCallback": function() {
                ...
                $('#tbstocklimit_info').css('padding-left', 10);
            }
        });
        tbstocklimit.on('order.dt search.dt', function() {
            tbstocklimit.column(0, {
                search: 'applied',
                order: 'applied'
            }).nodes().each(function(cell, i) {
                cell.innerHTML = i + 1;
        ...
        $('#tbpelangganterbaik thead tr').clone(true).appendTo('#tbpelangganterbaik thead');
        $(' #tbpelangganterbaik thead tr:eq(1) th').each(function(i) {
            ...
            if (i > 0) {
                ...
                $('input', this).on('keyup change', function() {
                    if (tbpelangganterbaik.column(i).search() !== this.value) {
                        tbpelangganterbaik
                            .column(i)
                            .search(this.value)
                            .draw();
